                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <p class="card-text">
                                            Data calon mentor yang akan dievaluasi untuk program magang internal:
                                        </p>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped mb-0">
                                            ...
                                            <tr>
                                                <th>No</th>
                                                <th colspan="2">Nama Calon Mentor</th>
                                            </tr>
                                            <?php
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel33">Tambah Calon Mentor</h4>
                    ...
                    <form action="alternatif-simpan.php" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <input type="text" name="name" placeholder="Nama Calon Mentor..." class="form-control"
                                    required>
                            </div>
                        </div>
